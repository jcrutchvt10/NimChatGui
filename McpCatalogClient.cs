...
namespace NimChatGui
{
    public class McpCatalogClient
    {
        ...
        public McpCatalogClient()
        {
            ...
            var configDir = Path.Combine(appData, "NimChatGui", "mcp");
        ...
        public List<McpServerDefinition> GetBuiltInCatalog()
        {
            ...
            return new List<McpServerDefinition>
            {
                ...
                new McpServerDefinition { Name = "aws-kb-retrieval-server", Description = "AWS Knowledge Base for Bedrock", Command = "npx", Args = new List<string> { "-y", "@modelcontextprotocol/server-aws-kb-retrieval-server" }, Category = "Cloud", Author = "AWS", SourceUrl = "https://github.com/aws-samples/mcp-servers" },
                ...
                // === Geolocation & Maps ===
                new McpServerDefinition { Name = "thinair-geo", Description = "Location & routing intelligence (geocoding, truck routing)", Command = "npx", Args = new List<string> { "-y", "@thinairtelematics/thinair-geo" }, Category = "Location", Author = "ThinAir", SourceUrl = "https://github.com/ThinAirTelematics/thinair-geo" },
                ...
                new McpServerDefinition { Name = "remixicon", Description = "Search and access Remix Icon library", Command = "npx", Args = new List<string> { "-y", "@remix-design/RemixIcon-MCP" }, Category = "Design", Author = "Remix", SourceUrl = "https://github.com/Remix-Design/RemixIcon-MCP" },

                // === Monitoring & Debugging ===
                new McpServerDefinition { Name = "sentry", Description = "Sentry error monitoring and debugging", Command = "npx", Args = new List<string> { "-y", "@modelcontextprotocol/server-sentry" }, Env = new Dictionary<string, string> { { "SENTRY_AUTH_TOKEN", "" }, { "SENTRY_ORG", "" } }, Category = "Monitoring", Author = "Sentry", SourceUrl = "https://github.com/modelcontextprotocol/servers" },
        ...
        private void LoadInstalledServers()
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine($"Failed to load installed servers: {ex.Message}");
            }
        }
        ...
        private void SaveInstalledServers()
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine($"Failed to save installed servers: {ex.Message}");
            }
        }
    }
}